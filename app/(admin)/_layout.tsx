...
export default function AdminLayout() {
  ...
  return (
    ...
    >
      <Tabs.Screen name="index" options={{ title: 'หน้าหลัก', tabBarIcon: ({ color, size }) => <Ionicons name="grid" size={size} color={color} />, headerTitle: '⚙️ แอดมิน' }} />
      ...
      <Tabs.Screen name="bills" options={{ title: 'บิล', tabBarIcon: ({ color, size }) => <Ionicons name="receipt" size={size} color={color} />, headerTitle: 'จัดการบิล' }} />
